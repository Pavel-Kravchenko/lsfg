...
directory="/raid/users/pk/working_dir/mixcr_results_from_KK_CD4/"
...
paired_pb_sf_cd4 <- read_delim("~/working_dir/spa_pb_sf_4_paired.txt", 
...
total_table_B27_B38_C12 <- merge(Patient, paired_pb_sf_cd4, by = "donor") %>% 
...
file_names1 <- grep(".+_4.txt", files, value=TRUE)
file_names2 <- grep(".+_4_p..txt", files, value=TRUE)
...
for (i in file_names){
  ...
  #print(colnames(curr))
  colnames(curr) <- c("count", "frequency", "CDR3nt", "CDR3aa", "V", "D", "J", "Vend", "Dstart", "Dend", "Jstart")
...
paired_pb_sf_cd4 <- read_delim("~/working_dir/spa_pb_sf_4_paired.txt", "\t", escape_double = FALSE, trim_ws = TRUE)  %>%
  select(status, donor, source, B27, B38, C12)
paired_pb_sf_cd4 <- paired_pb_sf_cd8 %>%  mutate(name = apply(paired_pb_sf_cd8[1:3], 1, paste, collapse="_"))
...
final_sure <- final_sure %>% mutate(Pr_B27 = N_B27/4)
...
final_sure_plot4 %>% 
  ...
  ggtitle('Fold change for 4-mers and V genes in 4 B27+ CD4 donors') +
  labs(x = "kmer + V gene", y = "fold change SF/PB in log10 scale") +
  scale_y_log10() +
...
final_sure_plot3 %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
  ggtitle('Fold change for 3-mers and V genes in 4 B27+ CD4 donors') +
  labs(x = "kmer + V gene", y = "fold change SF/PB in log10 scale") +
  scale_y_log10() +
  scale_fill_gradient(low ='light blue', high='navyblue')
...
final_sure <- final_sure %>% mutate(Pr_B38_neg = N_B38_neg/5)
...
final_sure_plot4 %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
  ggtitle('Fold change for 4-mers and V genes in 3 B38+ CD4 donors') +
  labs(x = "kmer + V gene", y = "fold change SF/PB in log10 scale") +
  scale_y_log10() +
  scale_fill_gradient(low ='light blue', high='navyblue')
...
final_sure_plot4 %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
  ggtitle('Fold change for 4-mers and V genes in 5 B38- CD4 donors') +
  labs(x = "kmer + V gene", y = "fold change SF/PB in log10 scale") +
  scale_y_log10() +
  scale_fill_gradient(low ='light blue', high='navyblue')
...
final_sure_plot3 %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
  ggtitle('Fold change for 3-mers and V genes in 3 B38+ CD4 donors') +
  labs(x = "kmer + V gene", y = "fold change SF/PB in log10 scale") +
  scale_y_log10() +
  scale_fill_gradient(low ='light blue', high='navyblue')
...
final_sure_plot3 %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
  ggtitle('Fold change for 3-mers and V genes in 5 B38- CD4 donors') +
  labs(x = "kmer + V gene", y = "fold change SF/PB in log10 scale") +
  scale_y_log10() +
  scale_fill_gradient(low ='light blue', high='navyblue')
...
ggplot(final_sure_plot4,aes(x=Pr_B27,y=fold_change_m,label=paste(kmer,V))) +
  ...
  scale_y_log10() +
  geom_point() +
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold change SF/PB ??????»???? 4-??????µ???????????? ???? V ??????µ???????????? B27+ CD4 ????????????????????????????", 
       x = "% B27+ ??????‚ 4 ????????????????????????????", y = "fold change in log10 scale")+ geom_text(check_overlap = TRUE)+
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25))
#lenKmer==3
ggplot(final_sure_plot3,aes(x=Pr_B27,y=fold_change_m,label=paste(kmer,V))) +
  ...
  scale_y_log10() +
  geom_point() +
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold change SF/PB ??????»???? 3-??????µ???????????? ???? V ??????µ???????????? B27+ CD4 ????????????????????????????", 
       x = "% B27+ ??????‚ 4 ????????????????????????????", y = "fold change in log10 scale") + geom_text(check_overlap = TRUE)+
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25))
#lenKmer==4
...
ggplot(final_sure_plot4,aes(x=Pr_B38,y=fold_change_m,label=paste(kmer,V))) +
  ...
  scale_y_log10() +
  geom_point() +
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold change SF/PB ??????»???? 4-??????µ???????????? ???? V ??????µ???????????? B38+ CD4 ????????????????????????????", 
       x = "% B38+ ??????‚ 3 ????????????????????????????", y = "fold change in log10 scale")+ geom_text(check_overlap = TRUE)+
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25))
...
ggplot(final_sure_plot3,aes(x=Pr_B38,y=fold_change_m,label=paste(kmer,V))) +
  ...
  scale_y_log10() +
  geom_point() +
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold change SF/PB ??????»???? 3-??????µ???????????? ???? V ??????µ???????????? B38+ CD4 ????????????????????????????", 
       x = "% B38+ ??????‚ 3 ????????????????????????????", y = "fold change in log10 scale")+ geom_text(check_overlap = TRUE)+
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25))
...
ggplot(final_sure_plot4,aes(x=Pr_B38_neg,y=fold_change_m,label=paste(kmer,V))) +
  ...
  geom_point() +
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold change SF/PB ??????»???? 4-??????µ???????????? ???? V ??????µ???????????? B38- CD4 ????????????????????????????", 
       x = "% B38- ??????‚ 5 ????????????????????????????", y = "fold change in log10 scale")+ geom_text(check_overlap = TRUE)+
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25))
...
ggplot(data = df2, aes(x = V_names, y = N, fill = source))+
  ...
  facet_wrap(donor~.)+
  facet_wrap(~donor, scales = "free_x")+
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold_change PB ???? SF ???????? V ??????µ??????°????", 
...
ggplot(data = vusage_fold, aes(x = V_names, y = fold_change_clones_log2))+
  geom_boxplot()+
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold_change ???????? ??????»??????????°???? PB ???? SF ??????»???? V ??????µ???????????? C12+", 
...
a <- ggplot(vusage_fold, aes(x = V_names, y = fold_change_clones_log2))+
  labs(title = "Fold change ???????? ??????»??????????°???? PB/SF ??????»???? V ??????µ???????????? B27+ CD4", 
...
b <-ggplot(Patients_common_table_2 %>% filter(B27=="1"),aes(x = V_names, fill=count)) + 
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ ??????»??????‚??????????????‚???? ???????? V ??????µ??????°???? B27+ CD4", 
       x = "V genes", y = "density")+
...
ggplot(data = vusage_fold, aes(x = V_names, y = fold_change_UMI_log2))+
  geom_boxplot()+
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold_change ???????? UMI PB ???? SF ??????»???? V ??????µ???????????? B27- CD4", 
       x = "V genes", y = "fold change")
...
a <- ggboxplot(data = vusage_fold, x = "V_names", y = "fold_change_clones_log10", sort.by.groups = TRUE)+
  labs(title = "?? ??°??????????????µ??????µ??»??µ??????????µ fold_change ???? ??????»??????‚??????????????‚???? ???????? ??????»??????????°???? PB/SF ??????»???? V ??????µ???????????? B27+ CD4", 
       x = "V genes", y = "log 10 PB/SF")+ 
...
Patients_common_table_2 %>%
  ...
  ggtitle('V usage by cln PB to SF CD8 B27+ CD4') +
...
a <- Patients_common_table_2 %>%
  ...
  ggtitle('V usage by clone number PB to SF CD4 B27+') +
...
a <- Patients_common_table_2 %>%
  ...
  ggplot(aes(x=V_names, y=logfc, fill=logfc>1, group=V_names), sort.by.groups = TRUE) +
  ggtitle('V usage by clone number PB to SF CD4 B38+') +
  geom_point(alpha=0.8, shape=21, color='black', size=2.5)  +
  geom_boxplot(alpha=0)+ theme_classic() +
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
...
a <- Patients_common_table_2 %>%
  ...
  ggplot(aes(x=V_names, y=logfc, fill=logfc>1, group=V_names), sort.by.groups = TRUE) +
  ggtitle('V usage by clone number PB to SF CD4 All') +
  geom_point(alpha=0.8, shape=21, color='black', size=2.5)  +
  geom_boxplot(alpha=0)+ theme_classic() +
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
...
b <-ggplot(Patients_common_table_2 %>%
             filter(V%in% HUMAN_TRBV) %>% 
             mutate(V_names=gsub("TRBV([0-9]?.+).*", "\\1", V)),aes(x=V_names, fill=source)) + 
  labs(title = "Density distribution by V genes in All CD4", 
       x = "V genes", y = "density")+
  geom_bar(alpha=.8, colour="black") + 
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
...
Patients_common_table_2 %>%
  ...
  ggtitle('V usage by clone count PB to SF CD4 B27+') +
  geom_point(alpha=0.8, shape=21, color='black', size=2.5)  +
  geom_boxplot(alpha=0)+ theme_classic() +
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
...
a <-Patients_common_table_2 %>%
  ...
  ggplot(aes(x=V_names, y=logfc, fill=logfc>1, group=V_names)) +
  ggtitle('V usage by clone count PB to SF CD4 B38+') +
  geom_point(alpha=0.8, shape=21, color='black', size=2.5)  +
  geom_boxplot(alpha=0)+ theme_classic() +
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
...
a <-Patients_common_table_2 %>%
  ...
  ggplot(aes(x=V_names, y=logfc, fill=logfc>1, group=V_names)) +
  ggtitle('V usage by clone count PB to SF CD4 C12+') +
  geom_point(alpha=0.8, shape=21, color='black', size=2.5)  +
  geom_boxplot(alpha=0)+ theme_classic() +
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
...
a <-Patients_common_table_2 %>%
  ...
  ggplot(aes(x=V_names, y=logfc, fill=logfc>1, group=V_names)) +
  ggtitle('V usage by clone count PB to SF CD4 All') +
  geom_point(alpha=0.8, shape=21, color='black', size=2.5)  +
  geom_boxplot(alpha=0)+ theme_classic() +
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
...
a <- t_p %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
  ggtitle('V usage by clone number PB/SF CD4 B27+ in % of 4 donors') +
  geom_hline(yintercept = 1, linetype='dashed') +
  labs(x = "V genes", y = "N of donors enriched")
...
a <- t_p %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust = 1, size=20), axis.text.y = element_text(vjust=0.5, hjust = 1,  size=20), 
        axis.title = element_text(size = 20), plot.title = element_text(size=25)) +
  ggtitle('V usage by clone count PB/SF CD4 B27+ in % of 4 donors') +
  geom_hline(yintercept = 1, linetype='dashed') +
  labs(x = "V genes", y = "N of donors enriched")
...
paired_pb_sf_cd8 <- read_delim("~/working_dir/spa_pb_sf_4_paired.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
ggplot(selected_petterns, aes(x=pattern_name, y=fc, fill = condition)) +
  ggtitle('Fold change by clone count CD4 in all as and psa') +
...
ggplot(selected_petterns %>% filter(B38 == 1), aes(x=pattern_name, y=fc, fill = condition)) +
  ggtitle('Fold change by clone count CD4 in B38+ as and psa') +
  geom_boxplot(alpha=0.5) +
  ylab('PB/SF for CDR3aa + V gene in log10 scale')  + scale_y_log10()+
  theme_classic()+
  geom_hline(yintercept = 1, linetype='dashed')+
...
ggplot(selected_petterns %>% filter(B27 == 1), aes(x=pattern_name, y=fc, fill = condition)) +
  ggtitle('Fold change by clone count CD4 in B27+ as and psa') +
  geom_boxplot(alpha=0.5) +
  ylab('PB/SF for CDR3aa + V gene in log10 scale')  + scale_y_log10()+
  theme_classic()+
  geom_hline(yintercept = 1, linetype='dashed')+
...
ggplot(selected_petterns, aes(x=pattern_name, y=fc, fill = MHC_status)) +
  ggtitle('Fold change by clone count CD4 in all donors') +
  geom_boxplot(alpha=0.5) +
  ylab('PB/SF for CDR3aa + V gene in log10 scale')  + scale_y_log10()+
  theme_classic()+
  geom_hline(yintercept = 1, linetype='dashed')+
